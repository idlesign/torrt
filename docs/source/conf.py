# -*- coding: utf-8 -*-
#
# torrt documentation build configuration file.
#
...
project = u'torrt'
copyright = u'2014-2025, Igor `idle sign` Starikov'
...
latex_documents = [
  ('index', 'torrt.tex', u'torrt Documentation',
...
man_pages = [
    ('index', 'torrt', u'torrt Documentation',
